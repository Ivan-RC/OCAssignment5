...
namespace OCAssignment5
{
    public partial class LuckyNumbers : Form
    {
        ...
        private void btn1_getNumber_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Pink":
                    result.ForeColor = Color.Pink;
                    break;
                case "Blue":
                    result.ForeColor = Color.Blue;
                    break;
                case "Light Blue":
                    result.ForeColor = Color.LightBlue;
                    break;
                case "Mint":
                    result.ForeColor = Color.MintCream;
                    break;
                case "Purple":
                    result.ForeColor = Color.Purple;
                    break;
                case "Red":
